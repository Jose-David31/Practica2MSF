"""
Práctica 2: Mecánica cardiovascular
...
fg2 = plt.figure()
plt.plot(t,Pp0,'-',linewidth=1,color = np.array([240,128,48])/255,label='Pp(t):Normotenso')
plt.plot(t,Pp3,':',linewidth=3,color = np.array([15,130,140])/255,label='Pp(t):Hipotenso PI')
plt.plot(t,Pp2,'-',linewidth=1,color = np.array([107,36,12])/255,label='Pp(t):Hipertenso')
plt.grid(False)
plt.xlim(0,10);plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
...
fg2.tight_layout()
fg2.savefig('sistema cardiovascular python hipo.png',dpi=600,bbox_inches='tight')
fg2.savefig('sistema cardiovascular python hipo.pdf')

fg3 = plt.figure()
plt.plot(t,Pp0,'-',linewidth=1,color = np.array([240,128,48])/255,label='Pp(t):Normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color = np.array([15,130,140])/255,label='Pp(t):Hipotenso')
plt.plot(t,Pp4,':',linewidth=4,color = np.array([107,36,12])/255,label='Pp(t):Hipertenso PI')
plt.grid(False)
plt.xlim(0,10);plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t) [V]')
...
fg3.tight_layout()
fg3.savefig('sistema cardiovascular python hiper.png',dpi=600,bbox_inches='tight')
fg3.savefig('sistema cardiovascular python hiper.pdf')
